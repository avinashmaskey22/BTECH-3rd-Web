...
/* 
Anonymous Function:
 - An anonymous function is a function without a name, usually assigned to a variable.
*/

/* let greet = function(name) {
    return "Happy Birthday Legend: " + name + "!";
};

console.log(greet("Cristiano Ronaldo"));  */

/* 
Arrow Function:
An arrow function is a more concise way to write functions using =>
*/

/* let greetArrow = (name) => "Welcome to " + name + "!";

console.log(greetArrow("KUSOED"));  */


/* 
Callback Function: (Task Learn This)
